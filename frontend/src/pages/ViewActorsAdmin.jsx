...
const SearchPage = () => {
  ...
  const fetchData = async () => {
    ...
    if (moviesResponse.error || actorsResponse.error || directorsResponse.error) {
      console.error('Error fetching data:', moviesResponse.error || actorsResponse.error || directorsResponse.error);
    } else {
