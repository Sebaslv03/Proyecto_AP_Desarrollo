          ...
          <div key={catIndex} className="mb-8 w-[1532px] h-[587px]">
            ...
            <div className="relative">
              <div className="flex justify-center overflow-x-auto space-x-4">
                ...
                <div key={index} className="flex-shrink-0 w-[284px] h-[377px] bg-[#1A1A1A] p-2 rounded-[12px] cursor-pointer flex flex-col items-center justify-between" onClick={() => handleItemClick(movie, category)}>
              ...
              <div className="absolute right-0 flex items-center justify-center mr-6 mt-10 space-x-2">
                ...
                <Button onClick={() => handleAddButton(category.name)} variant="outline" className='w-[56px] h-[56px] bg-black border-1' size="icon">
                  <CirclePlus className="h-28px w-28px" />
                </Button>
              </div>
            </div>
          </div>
