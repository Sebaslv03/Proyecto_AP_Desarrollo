                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 items-start">
                    <div className="grid grid-cols-1 col-span-1 md:col-span-2 gap-6 items-center">
                        <div className='bg-[#262626] rounded-md px-4 py-4'>
                            <h5 className="text-lg font-medium mb-2">Biography</h5>
                            <p className="text-[#757070] text-base font-thin">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>
                        </div>
                        <div className='bg-[#262626] rounded-md px-4 py-4'>
                            <h5 className="text-lg font-medium mb-2">Trivia</h5>
                        ...
                        <div className='bg-[#262626] rounded-md px-4 py-4'>
                            <h5 className="text-lg font-medium mb-2">Movies Involved In</h5>
                            <ul className="list-disc list-inside text-[#757070] text-base font-thin">
                                <li>Movie Title 1</li>
                                <li>Movie Title 2</li>
                                <li>Movie Title 3</li>
                    ...
                    <div className='bg-[#262626] rounded-md px-4 py-4'>
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Full Name</h5>
                            <p className="text-[#757070] text-base font-thin">John Doe</p>
                        </div>
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Date of Birth</h5>
                            <p className="text-[#757070] text-base font-thin">January 1, 1970</p>
                        </div>
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Birthplace</h5>
                            <p className="text-[#757070] text-base font-thin">City, Country</p>
                        </div>
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Nationality</h5>
                            <p className="text-[#757070] text-base font-thin">Nationality</p>
                        </div>
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Parents</h5>
                        ...
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Spouses</h5>
                            <p className="text-[#757070] text-base font-thin">Spouse Name</p>
                        </div>
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Siblings</h5>
                            <p className="text-[#757070] text-base font-thin">Sibling Name 1, Sibling Name 2</p>
                        </div>
                        <div className="mb-6">
                            <h5 className="text-lg font-medium mb-2">Height</h5>
